...
export default class Rules {
  ...
  static required (value: Array<any> | string | null = ''): boolean {
    return (Array.isArray(value) && value.length > 0) || (typeof value === 'string' && !!value) || (typeof value === 'object' && !Array.isArray(value) && value !== null) || (typeof value === 'number' && !isNaN(value));
  }
