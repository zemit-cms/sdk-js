(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('moment'), require('ip-address'), require('deepmerge'), require('axios'), require('store2'), require('camel-case'), require('uuid')) :
  typeof define === 'function' && define.amd ? define(['exports', 'moment', 'ip-address', 'deepmerge', 'axios', 'store2', 'camel-case', 'uuid'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Zemit = {}, global.moment, global.IpAddress, global.deepmerge, global.axios, global.store, global.camelCase, global.uuid));
})(this, (function (exports, moment, IpAddress, deepmerge, axios, store, camelCase, uuid) { 'use strict';
  ...
  var IpAddress__namespace = /*#__PURE__*/_interopNamespaceDefault(IpAddress);
  ...
  class Rules {
      ...
      static ipv4(ipv4) {
          try {
              return new IpAddress__namespace.Address4(ipv4).isCorrect();
          }
          catch (e) {
              return false;
          }
      ...
      static ipv6(ipv6) {
          try {
              return new IpAddress__namespace.Address6(ipv6).isCorrect();
          }
          catch (e) {
              return false;
          }
  ...
  class Utils {
       ...
       */
      static camelize(str) {
          return camelCase.camelCase(str, { transform: camelCase.camelCaseTransformMerge });
      }
      /**
